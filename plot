...
#fit f(x, y, t) "daily-simple" using (log($2 + epsilon)):(log($58 + epsilon)):($61):(log($1 + epsilon)):(1) via work_weight, home_weight, mixed_use_wt, work_exp, home_exp, work_mu_exp, home_mu_exp, intercept
